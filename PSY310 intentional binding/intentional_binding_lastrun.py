...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\aangi\\psychopy\\PSY310 intentional binding\\intentional_binding_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text='Report the delay between the key press and the beeb sound (0-999); Click\nsubmit after entering the value',
        font='Arial',
