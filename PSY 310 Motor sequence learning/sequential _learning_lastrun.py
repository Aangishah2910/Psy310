...
expName = 'sequential _learning'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\aangi\\psychopy\\PSY 310 Motor sequence learning\\sequential _learning_lastrun.py',
